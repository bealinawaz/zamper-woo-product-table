...
/**
 * ZWPT FAQ Page Function
 * Added Description, Available Attribute List
 */
function wpt_faq_page() {
    ?>
    <style type="text/css">
        input.regular-text.code {
    width: 95%;
}
    </style>
    <div class="wrap">
        <h1>Welcome to <span style="color: #04b0db;">Zamper Woocommerce Product Table</span></h1>
        <div class="card" style="width: 100%; max-width: 95.5%;">
            <h2 class="title">Shortcode</h2>
            <p><input width="100% !important" value="[wpt-shop title='All Products' class='' table_class='' product_cat_ids='' product_cat_slugs='' short='asc' min_price='' max_price='']" class="regular-text code" type="text" readonly="readonly"></p>
        </div>
        <div class="card" style="width: 100%; max-width: 95.5%;">
